...
curve(((4*N*(1-x)*x*N)/((x*N*(1+f))+((1-x)*N*(1+m))))/N, from=0, to=1, lty=2,
      xlab="proportion of males", ylab="NeA/N", main="Autosomes", ylim=c(0,1), xlim=c(0,1))
...
curve(((9*N*(x)*N*(1-x))/((4*N*x*(1+f))+(2*N*(1-x)*(1+m))))/N, from=0, to=1, lty=2, xlab="proportion of males", ylab="Ne/N", main="Sex chromosomes", ylim=c(0,1),xlim=c(0,1))
