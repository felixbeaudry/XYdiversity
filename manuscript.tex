...
Such that with no variation in mating success for males or females ($C^2_{d{m}}=C^2_{d{f}}=0$), equations 2 and 3 reduces to the familiar expressions:
